...
console.log('Starting complaint-service with module aliasing...');
...
try {
  // For complaint-service
  console.log('Attempting to load main.js...');
  require('./dist/main.js');
} catch (err) {
  if (err.code === 'MODULE_NOT_FOUND' && err.requireStack && err.requireStack[0] === './dist/main.js') {
    try {
      // For other service patterns
      console.log('main.js not found, trying server.js...');
